...
pub(crate) fn generate_rust_binding(in_h_path: &Path, out_rs_path: &Path) {
    ...
    // Listening to changes on files that are generated by this build step
    // cause an infinite loop with cargo watch of build -> detect change -> rebuild -> detect change -> ...
    //
    // TODO: Test if this loop still occurs if we change the build dir
    //       to OUT_DIR. Discussion here: https://discord.com/channels/723850269347283004/1170798739166863510/1170802314878124142
